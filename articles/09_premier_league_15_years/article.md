...
## League position points expose depth as well as longevity
...
This is why raw totals should be paired with per-game measures. Longevity is a real achievement, but it is not identical to efficiency. A promoted club should not be judged as though it had fifteen years to accumulate the same total.

## The best teams occupy a narrow performance frontier
...
Correlation is not a tactical instruction and does not prove causation. It does show that the statistical profile of success is internally coherent: strong teams create more, concede less and turn that balance into points repeatedly.

## Discipline changes with the era and resists a simple rule
...
## What sustained success looks like in one frame
...
The five views distinguish a memorable season from a durable football institution. Validation protects the analysis from bad inputs, cumulative points reward repeated excellence, league-position scoring reveals depth across eras, the performance frontier connects attack and defence, and discipline shows how style changes over time. No single statistic carries the argument alone.

Together they suggest that long-run Premier League success is an organisational outcome. Great sides score heavily, defend efficiently and adapt to the tactical and disciplinary environment around them, but the clubs that dominate fifteen years repeatedly rebuild those qualities. Sustained advantage comes from reproducing performance after the original team has changed.
